...
//   }
// }
const path = require('path') // Import path if not already
...
module.exports = {
  ...
  async rewrites() {
    return [
      {
        source: '/sap-api/:path*', // Jab /sap-api/ se request aayegi
        destination: 'http://89.117.56.27:50004/b1s/v1/:path*' // Proxy SAP server pe
      }
    ]
  }
}
