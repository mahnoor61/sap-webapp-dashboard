        ...
        <>
          ...
          <React.Fragment>
            <Dialog
              ...
              aria-describedby='alert-dialog-description'
            >
                <DialogTitle id='alert-dialog-title'>{'Make Ready Time'}</DialogTitle>
                <DialogContent>
                  <Typography variant='h2'>Are you sure you want to start make ready time?</Typography>
                </DialogContent>
                <DialogActions>
                  <Button onClick={handleStopClickClose}>No</Button>
