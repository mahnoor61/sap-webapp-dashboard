    ...
    onSubmit: async values => {
      try {
        ...
        try {
          ...
          console.log('sapResponse issue for machine=>', sapResponse.data.data)
        } catch (error) {
    ...
    onSubmit: async values => {
      try {
        ...
        try {
          ...
          console.log('sapResponse of completed quantity=>', sapResponse.data.data)
        } catch (error) {
                            ...
                            {isDownClick ? (
                              ...
                              <>
                                {!makeTimerRunning &&
                                  ...
                                  !isMakeTimeDone && (
                                    <Button variant='contained' onClick={handleStartMakeTime} sx={{ bgcolor: 'blue' }}>
                                      Make Time
                                    </Button>
                                  )}
                    ...
                    <TableContainer sx={{ width: '100%', overflowX: 'auto' }}>
                      <Table size='small'>
                        <TableBody>
                          ...
                          <TableRow>
                            <TableCell sx={{ width: '50%' }}>
                              <strong>Previous Route Completed Quantty:</strong>
                            </TableCell>
