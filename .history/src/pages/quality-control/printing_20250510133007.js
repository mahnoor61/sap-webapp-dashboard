    ...
    <>
      ...
      >
            ...
            <Table size='small' sx={{ border: '1px solid #999', width: '100%' }}>
              <TableBody>
                <TableRow>
                  ...
                  <TableCell rowSpan={2} align='center' sx={{ border: '1px solid #999', width: 200 }}>
                    {/* Replace with actual logo src */}
                    <img src='/path-to-logo.png' alt='UBC Logo' width='60' />
                    <Typography sx={{ fontWeight: 'bold', fontSize: '14px' }}>UBC Convertec (Pvt) Ltd.</Typography>
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell sx={{ border: '1px solid #999', fontWeight: 500 }}>Document Code:</TableCell>
                  <TableCell sx={{ border: '1px solid #999', fontWeight: 'bold' }}>UBC/QC/SOR-03</TableCell>
                  <TableCell sx={{ border: '1px solid #999', fontWeight: 500 }}>Version #:</TableCell>
                  <TableCell sx={{ border: '1px solid #999', fontWeight: 'bold' }}>02</TableCell>
                  <TableCell sx={{ border: '1px solid #999', fontWeight: 500 }}>Issue Date:</TableCell>
                  <TableCell sx={{ border: '1px solid #999', fontWeight: 'bold' }}>08 Nov 2017</TableCell>
                </TableRow>
              </TableBody>
            </Table>
          </Box>
        ...
        <DialogContent>
          ...
          <Table size='small' sx={{ border: '1px solid #ccc', mt: 20, mb: 20 }}>
            <TableHead>
              <TableRow>
