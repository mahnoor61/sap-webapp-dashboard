                ...
                >
                  <thead style={{ backgroundColor: 'skyblue' }}>
                    <tr>
                      ...
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' , width: '5%'}}>Doubling</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' }}>Dust</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold', width: '5%' }}>
                        Set Off
                      </th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' , width: '5%'}}>Scumming</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' ,  width: '5%'}}>Side Lay</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' , width: '5%'}}>Front Lay</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' , width: '5%'}}>registration</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold', width: '5%' }}>D/M/S from Plate</th>
                    </tr>
                  </thead>
