      ...
      <CardContent>
        <form onSubmit={formik.handleSubmit}>
          <Grid container spacing={2} sx={{ px: { xs: 2, md: 20 } }}>
            <Grid item xs={12}>
              <FormControl>
                <FormLabel id='demo-radio-buttons-group-label'>Text</FormLabel>
                <RadioGroup
                  aria-labelledby='demo-radio-buttons-group-label'
                  defaultValue='female'
                  name='radio-buttons-group'
                >
                  <FormControlLabel value='Okay' control={<Radio />} label='Female' />
                  <FormControlLabel value='NOT oKAY' control={<Radio />} label='Male' />
