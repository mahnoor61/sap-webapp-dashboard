      ...
      >
        ...
        <DialogContent>
          ...
          {/* <Table size='small' sx={{ border: '1px solid #ccc', mt: 20, mb: 20 }}>
            <TableHead sx={{ bgcolor: 'skyBlue', color: 'white' }}>
              <TableRow>
                <TableCell>Sr. No</TableCell>
                <TableCell>Quality Parameter</TableCell>
                <TableCell sx={{ fontWeight: 'bold', whiteSpace: 'pre-line' }}>Time{'\n'}(e.g. 10:00 AM)</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {[
          ...
          */}
          <Table size='small' sx={{ border: '1px solid #ccc', mt: 4, mb: 4, overflowX: auto }}>
            <TableHead sx={{ bgcolor: 'skyblue' }}>
              <TableRow>
                <TableCell sx={{ fontWeight: 'bold' }}>Sr. No</TableCell>
                <TableCell sx={{ fontWeight: 'bold' }}>Quality Parameter</TableCell>
                {users
                  .filter(user => !user.makeTimeStatus)
                  .map((user, idx) => (
                    <TableCell key={user._id} sx={{ fontWeight: 'bold', whiteSpace: 'nowrap' }}>
