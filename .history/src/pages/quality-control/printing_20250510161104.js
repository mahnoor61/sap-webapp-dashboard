...
const Printing = () => {
        ...
        <DialogTitle>
          <div style='margin-bottom: 20px;'>
            <table style='width: 100%; border: 1px solid #999; border-collapse: collapse;'>
              ...
              <tr>
                <td style='border: 1px solid #999; font-weight: 500;'></td>
  ...
  <div style="min-width: 1000px;"> <!-- adjust width dynamically -->
    ...
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
      ...
      <tr>
        <td>Job Name:</td>
        <td colspan="3" style="text-align: center;"><!-- Job Name --></td>
      </tr>
      <tr>
        <td>PRDN. No:</td>
        <td><!-- PRDN No --></td>
    ...
    <table style="width: 100%; border: 1px solid #ccc; border-collapse: collapse;">
      <thead style="background-color: skyblue;">
        <tr>
          ...
          <th style="border: 1px solid #ccc;">Quality Parameter</th>
          <!-- Time Columns -->
          <!-- Example: -->
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="border: 1px solid #ccc;">Text</td>
          <!-- For each user column -->
          <td style="border: 1px solid #ccc; text-align: center;">
            ✓
          </td>
        </tr>
        <!-- If makeTimeStatus row -->
        <tr>
          <td colspan="2" style="border: 1px solid #ccc;"></td>
          <td colspan="X" style="border: 1px solid #ccc; text-align: center; background-color: #e6f7ff;">
            make ready time
          </td>
        </tr>
      </tbody>
