...
const Printing = () => {
  ...
  return (
    ...
    >
      <DialogTitle>
        <Typography variant='h5'>QC Report For Printing</Typography>
        <Typography variant='body2'>UBC Convertec (Pvt) Ltd.</Typography>
      </DialogTitle>
      <DialogContent>
        <Box mb={2}>
          <Table size='small'>
        ...
        <Table size='small' sx={{ border: '1px solid #ccc' }}>
          <TableHead>
            <TableRow>
              ...
              <TableCell>Quality Parameter</TableCell>
              <TableCell>Time</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
        ...
        <Box mt={2}>
          <Table size='small'>
            <TableBody>
              <TableRow>
                <TableCell>Initial (Opr/Sup):</TableCell>
                <TableCell />
                <TableCell>Meter Counter:</TableCell>
                <TableCell />
              </TableRow>
              <TableRow>
  ...
  >
    ...
    <DialogContent>
      <div id='qc-report' style={{ padding: '10px' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: '20px' }}>
          <tbody>
            <tr><td><strong>Machine:</strong> {userData.machine || '-'}</td></tr>
            <tr><td><strong>Operator Name:</strong> {userData.operator || '-'}</td></tr>
            <tr><td><strong>Shift:</strong> {userData.shift || '-'}</td></tr>
            <tr><td><strong>Date:</strong> {userData.date || '-'}</td></tr>
            <tr><td><strong>Job Name:</strong> {userData.jobName || '-'}</td></tr>
            <tr><td><strong>PRDN. No.:</strong> {userData.productionNo || '-'}</td></tr>
            <tr><td><strong>S O No.:</strong> {userData.soNo || '-'}</td></tr>
          </tbody>
        </table>
        ...
        <table style={{ width: '100%', border: '1px solid #ddd', borderCollapse: 'collapse' }}>
          <thead>
            <tr>
              ...
              <th style={headerStyle}>Quality Parameters</th>
          ...
          <tbody>
            {[
              ...
              <tr key={index}>
                ...
                <td style={cellStyle}>{param}</td>
                <td style={cellStyle}>{userData.qcTimes?.[index] || '-'}</td>
              </tr>
            ))}
          </tbody>
        </table>
        ...
        <table style={{ marginTop: '20px', width: '100%' }}>
          <tbody>
            <tr>
              <td><strong>Initial (Opr/Sup):</strong> {userData.initials || '-'}</td>
              <td><strong>Meter Counter:</strong> {userData.meterCounter || '-'}</td>
            </tr>
            {/* <tr>
              <td colSpan={2}><strong>Supervisor:</strong> {userData.supervisor || '_______________'}</td>
            </tr> */}
            {/* <tr>
              <td colSpan={2}>
                <strong>Remarks:</strong> <br />
                {userData.remarks || '_________________________________________________________'}
              </td>
            </tr> */}
          </tbody>
        </table>
