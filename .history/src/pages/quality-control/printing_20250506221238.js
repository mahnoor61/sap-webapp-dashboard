                ...
                <Box sx={{ overflowX: 'auto', width: '100%' }}>
                  <TableContainer component={Paper} sx={{ minWidth: '800px' }}>
                    <Table aria-label='simple table' sx={{ minWidth: 800 }}>
                      ...
                      <TableBody sx={{ width: '100%' }}>
                        <TableBody sx={{ width: '100%', bgcolor: 'skyblue' }}>
                          {userData?.makeTime && userData?.makeTimeStatus ? (
                            <TableRow sx={{ width: '100%', bgcolor: 'yellow' }}>
                              <TableCell>{new Date(userData.makeTime).toLocaleTimeString()}</TableCell>
                              <TableCell colSpan={11} sx={{ width: '100%', bgcolor: 'pink' }}>
                                <Box
                                  sx={{
                                    bgcolor: 'red',
                                    width: '100%',
