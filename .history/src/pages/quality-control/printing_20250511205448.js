                ...
                >
                  <thead style={{ backgroundColor: 'skyblue' }}>
                    <tr>
                      ...
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' , width:''}}>Time</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' }}>Text</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' }}>Color Variation</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' }}>Doubling</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' }}>Dust</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' }}>Set Off</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' }}>Scumming</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' }}>Side Lay</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' }}>Front Lay</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' }}>registration</th>
                      <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' }}>D/M/S from Plate</th>
                    </tr>
                  </thead>
