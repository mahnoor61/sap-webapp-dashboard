...
const Printing = () => {
  ...
  <table style="width: 100%; border: 1px solid #999; border-collapse: collapse;">
    <tr>
      <td colspan="4" style="border: 1px solid #999; font-weight: bold; text-align: center;">
        QC Report For Printing
      </td>
      <td rowspan="4" style="border: 1px solid #999; text-align: center; width: 200px;">
        <img src="/white-logo.png" alt="UBC Logo" width="60" /><br />
        <div style="font-weight: bold; font-size: 14px;">UBC Convertec (Pvt) Ltd.</div>
      </td>
    </tr>
    <tr>
      <td style="border: 1px solid #999; font-weight: 500;">
        Document Code: <!-- Inject value with JS if needed -->
      </td>
      <td style="border: 1px solid #999; font-weight: bold;">UBC/QC/SOR-01</td>
      <td style="border: 1px solid #999; font-weight: 500;">Issue Date:</td>
      <td style="border: 1px solid #999; font-weight: bold;">08 Nov 2017</td>
    </tr>
  </table>
</div>
          {/* <Box mb={2}>
            <Table size='small' sx={{ border: '1px solid #999', width: '100%' }}>
              <TableBody>
                ...
                <TableRow>
                  ...
                  {/* <TableCell sx={{ border: '1px solid #999', fontWeight: 500 }}>Version #: 02</TableCell> */}
