            ...
            <Grid item lg={12}>
              <Paper sx={{ padding: 2, overflowX: 'auto' }}>
                      ...
                      {rows.map((row, rowIndex) => (
                        <TableRow key={row.id}>
                          {questions.map((question, colIndex) => {
                            ...
                            // Columns to skip (index 0 = '#', 1 = 'Time', 2 = 'Quantity')
                            if (colIndex < 3) {
                              return (
                                <TableCell key={cellKey} sx={{ color: 'black' }}>
                                  {colIndex === 0 ? row.serial : ''} {/* Show serial in '#' column only */}
                                </TableCell>
                              )
                            } else {
                              return (
                                    ...
                                    editingCell === cellKey ? (
                                      <Select
                                        ...
                                        onChange={e => {
                                          ...
                                          const [rowIndex, colIndex] = cellKey.split('_')
                                          const serialNo = rows[rowIndex]?.serial
                                          const header = questions[colIndex]
                                        ...
                                        size='small'
                                      >
                                        <MenuItem value='Okay' sx={{ color: 'black' }}>
                                          Okay
                                        </MenuItem>
                                        <MenuItem value='Not Okay' sx={{ color: 'black' }}>
                                          Not Okay
                                        </MenuItem>
                                      </Select>
                                    ) : // (
                ...
                {responses && Object.entries(responses).some(([_, val]) => val.answer === 'Not Okay') && (
                  <Box mt={4} p={2} border='1px solid #ccc' borderRadius='10px' bgcolor='#f9f9f9' color='black'>
...
// Saved Responses:
// {Text: {…}, color Variation: {…}, doubling: {…}, dust: {…}, set Off: {…}, …}
//
// Text:{answer: 'Okay', reason: '', serialNo: 'A001'}
// color Variation:{answer: 'Okay', reason: '', serialNo: 'A001'}
// dmsFromPlate:{answer: 'Okay', reason: '', serialNo: 'A001'}
// doubling:{answer: 'Okay', reason: '', serialNo: 'A001'}
// dust:{answer: 'Okay', reason: '', serialNo: 'A001'}
// front Lay:{answer: 'Okay', reason: '', serialNo: 'A001'}
// registration:{answer: 'Okay', reason: '', serialNo: 'A001'}
// scumming:{answer: 'Okay', reason: '', serialNo: 'A001'}
// set Off:{answer: 'Okay', reason: '', serialNo: 'A001'}
// side Lay:{answer: 'Not Okay', reason: 'layer is dusty', serialNo: 'A001'}
