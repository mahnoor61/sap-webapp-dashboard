          ...
          <DialogContent>
            <div style={{ overflowX: 'auto' }}>
              <div style={{ minWidth: `${users.length * 100 + 300}px` }}>
                ...
                <table style='width: 100%; border: 1px solid #ccc; border-collapse: collapse; margin-bottom: 24px;'>
                  <thead style='background-color: skyblue;'>
                    <tr>
                      <th style='padding: 6px; border: 1px solid #ccc; font-weight: bold;'>Sr. No</th>
                      <th style='padding: 6px; border: 1px solid #ccc; font-weight: bold;'>Time</th>
                      <th style='padding: 6px; border: 1px solid #ccc; font-weight: bold;'>Text</th>
                      <th style='padding: 6px; border: 1px solid #ccc; font-weight: bold;'>Color Variation</th>
                      <th style='padding: 6px; border: 1px solid #ccc; font-weight: bold;'>Doubling</th>
                      <th style='padding: 6px; border: 1px solid #ccc; font-weight: bold;'>Dust</th>
                      <th style='padding: 6px; border: 1px solid #ccc; font-weight: bold;'>Set Off</th>
                      <th style='padding: 6px; border: 1px solid #ccc; font-weight: bold;'>Scumming</th>
                      <th style='padding: 6px; border: 1px solid #ccc; font-weight: bold;'>Side Lay</th>
                      <th style='padding: 6px; border: 1px solid #ccc; font-weight: bold;'>Front Lay</th>
                      <th style='padding: 6px; border: 1px solid #ccc; font-weight: bold;'>Misregistration</th>
                      <th style='padding: 6px; border: 1px solid #ccc; font-weight: bold;'>D/M/S from Plate</th>
                    </tr>
                  </thead>
                      ...
                      if (user.makeTimeStatus) {
                        return (
                          <tr key={user._id}>
                            ...
                            <td
                              colspan='11'
                              style='padding: 6px; border: 1px solid #ccc; font-weight: bold; background-color: #e6f7ff; text-align: center;'
                            >
                              {user.makeTimeStatus}
                            </td>
                          </tr>
