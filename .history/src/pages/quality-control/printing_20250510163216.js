          ...
          <div style={{ marginBottom: '20px' }}>
            <table style={{ width: '100%', border: '1px solid #999', borderCollapse: 'collapse' }}>
              ...
              <tr>
                ...
                <td style={{ border: '1px solid #999', fontWeight: '500' }}>Issue Date:{formattedDate}</td>
              ...
              >
                <thead style={{ backgroundColor: 'skyblue' }}>
                  <tr>
                    ...
                    <th style={{ padding: '6px', border: '1px solid #ccc', fontWeight: 'bold' }}>Quality Parameter</th>
                    {users.map(user => (
                      <th
                        key={user._id}
                        style={{
                ...
                <tbody>
                  {parameters.map((param, index) => (
                    <tr key={param.key}>
                      ...
                      <td style={{ padding: '6px', border: '1px solid #ccc' }}>{param.label}</td>
                      {users.map(user => {
