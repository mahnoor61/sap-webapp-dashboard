                ...
                >
                  <Grid item xs={12}>
                    <Grid container spacing={2}>
                      <Grid item xs={6} lg={3}>
                        <TextField fullWidth label='Job Card No' value={userData?.jobData?.cardCode} size='small' />
                      </Grid>
                      <Grid item xs={6} lg={3}>
                        <TextField fullWidth label='Job Name' value={userData?.jobData?.cardName} size='small' />
                      </Grid>
                      <Grid item xs={6} lg={3}>
                        <TextField fullWidth label='Sales Order Nbr' value={userData?.jobData?.cardName} size='small' />
                      </Grid>
                      <Grid item xs={6} lg={3}>
                        <TextField fullWidth label='Sheet Name' value={userData?.jobData?.cardName} size='small' />
                      </Grid>

                      <Grid item xs={6} lg={3}>
                        <TextField fullWidth label='Received Qty' value={userData?.jobData?.cardName} size='small' />
                      </Grid>
                      <Grid item xs={6} lg={3}>
                        <TextField fullWidth label='Sales Order Nbr' value={userData?.jobData?.cardName} size='small' />
                      </Grid>
