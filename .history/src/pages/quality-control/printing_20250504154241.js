          ...
          <Grid item lg={12}>
            <Paper sx={{ padding: 2, overflowX: 'auto' }}>
              ...
              <Grid container spacing={2} mb={2}>
                ...
                <Box
                  sx={{ bgcolor: 'skyblue', width: '100%', display: 'flex', p: 3, mt: 5, mb: 5, borderRadius: '10px' }}
                >
                  <Grid item xs={12} md={4}>
                    <Box sx={{ display: 'flex', gap: 2 }}>
                      <Typography variant='subtitle2' sx={{fontWeight:'900'}}>Document Code:</Typography>
                  ...
                  <Grid item xs={12} md={4} textAlign='right'>
                    <Box sx={{ display: 'flex', gap: 2 }}>
                      ...
                      <Typography>21/04/2024</Typography>
                    </Box>
                  </Grid>
                </Box>
                <Grid item xs={12} sm={3}>
                  <TextField fullWidth label='Machine' value='PM 6' size='small' />
                </Grid>
                <Grid item xs={12} sm={3}>
                  <TextField fullWidth label='Operator Name' value='Admin' size='small' />
                </Grid>
                <Grid item xs={6} sm={2}>
                  <TextField fullWidth label='Shift' value='A' size='small' />
                </Grid>
                <Grid item xs={6} sm={4}>
                  <TextField fullWidth label='Date' value='21/04/2024' size='small' />
                </Grid>

                <Grid item xs={12}>
                  <Grid container spacing={2}>
                    {['Job Card No.', 'Job Name', 'Sales Order Nbr', 'Sheet Name', 'Received Qty', 'Completed Qty'].map(
                      label => (
