...
const AddQuality = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async values => {
      try {
        ...
        router.push(`/quality-control/printing?jobId=${values.jobId}`)
        handleClose()
        formik.resetForm()
      } catch (error) {
  ...
  const handleMakeTimeClick = async () => {
    try {
      ...
      router.push(`/quality-control/printing?jobId=${formik.values.jobId}`)
      handleClose()
    } catch (error) {
        ...
        >
          <form onSubmit={formik.handleSubmit}>
            ...
            <DialogActions>
              ...
              <Button onClick={handleMakeTimeClick}>Make Time</Button>
              {/* </NextLink> */}
              {/* <NextLink href='/Quality Control/printing'> */}
