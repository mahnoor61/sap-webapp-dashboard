...
const AddQuality = () => {
  ...
  const getAllJobsOfSelectedMachine = async () => {
    try {
      const response = await axios.get(`${BASE_URL}/api/ap/qc/get/machine-data`, {
        headers: {
          'x-access-token': token
        }
      })
